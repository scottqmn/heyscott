...
type BlogPostDocumentDataBodySlice = RichTextSlice | HeadingSlice | QuoteSlice | CodeBlockSlice | ImagesSlice | DividerSlice
...
interface BlogPostDocumentData {
	 ...
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: Shown as the preview message in the blog thread
 ...
 */
export type BlogPostDocument<Lang extends string = "en-us"> = prismic.PrismicDocumentWithUID<Simplify<BlogPostDocumentData>, "blog_post", Lang>;
...
export interface CodeBlockSliceDefaultPrimary {
	 ...
	 */
	language: prismic.SelectField<"plaintext" | "javascript" | "typescript" | "jsx" | "tsx" | "css" | "json" | "bash" | "markdown", "filled">;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeadingSliceDefault = prismic.SharedSliceVariation<"default", Simplify<HeadingSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ImagesSliceDefault = prismic.SharedSliceVariation<"default", Record<string, never>, Simplify<ImagesSliceDefaultItem>>;
